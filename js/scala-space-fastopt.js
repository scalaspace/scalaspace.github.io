...
$c_Lscalaspace_ScalaSpace$.prototype.initialize__V = (function() {
  ...
  var this$4 = this$3.apply__T__T__T__I__sci_Map__Z__T__s_concurrent_Future("GET", "data/groups.json", "", 0, headers, false, "");
  var pf = new $c_Lscalaspace_ScalaSpace$$anonfun$initialize$1().init___Lgoogle_maps_Map(map);
...
$c_Lscalaspace_ScalaSpace$.prototype.main__V = (function() {
  $g["google"]["maps"]["event"]["addDomListener"]($g["window"], "load", (function() {
    $m_Lscalaspace_ScalaSpace$().initialize__V()
  }));
  var contribute = $g["document"]["getElementById"]("contribute");
  var qual$1 = $g["document"]["getElementById"]("expand-contribute");
  var x$49 = (function(contribute$1) {
    return (function(event$2) {
      contribute$1["setAttribute"]("style", "display:block")
    })
  })(contribute);
  qual$1["addEventListener"]("click", x$49);
  var qual$2 = $g["document"]["getElementById"]("collapse-contribute");
  var x$52 = (function(contribute$1$1) {
    return (function(event$2$1) {
      contribute$1$1["setAttribute"]("style", "display:none")
    })
  })(contribute);
  qual$2["addEventListener"]("click", x$52)
});
...
$c_Lscalaspace_ScalaSpace$.prototype.onClick__Lgoogle_maps_Map__Lgoogle_maps_Marker__Lscalaspace_Group__V = (function(map, marker, group) {
  var thiz = group.url$1;
  if ((($uI(thiz["length"]) >= 0) && ($as_T(thiz["substring"](0, $uI("http"["length"]))) === "http"))) {
    var link = group.url$1
  } else {
    var link = new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["http://www.meetup.com/", "/"])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([group.url$1]))
  };
  var content = $g["document"]["createElement"]("a");
  content["setAttribute"]("href", link);
  content["innerHTML"] = group.name$1;
  this.infoWindow$1["setContent"](content);
  this.infoWindow$1["open"](map, marker)
});
...
/** @constructor */
var $c_sjs_js_Any$CanBuildFromArray$1 = (function() {
  $c_O.call(this)
});
...
/** @constructor */
var $h_sjs_js_Any$CanBuildFromArray$1 = (function() {
  /*<skip>*/
});
...
$c_Lscalaspace_Groups.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    ...
    return $m_sr_BoxesRunTime$().equals__O__O__Z(this.groups$1, Groups$1.groups$1)
  } else {
    return false
  }
});
...
$c_Lscalaspace_Groups.prototype.init___sjs_js_Array = (function(groups) {
...
/** @constructor */
var $c_Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$1 = (function() {
  $c_sr_AbstractFunction1.call(this);
  this.$$outer$2 = null
});
$c_Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$1.prototype = new $h_sr_AbstractFunction1();
$c_Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$1.prototype.constructor = $c_Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$1;
/** @constructor */
var $h_Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$1 = (function() {
  /*<skip>*/
});
$h_Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$1.prototype = $c_Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$1.prototype;
$c_Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$1.prototype.init___Lscalaspace_ScalaSpace$$anonfun$initialize$1 = (function($$outer) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
...
$c_Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$1.prototype.apply__O__O = (function(v1) {
  return this.apply__Lscalaspace_Group__Lgoogle_maps_Marker($as_Lscalaspace_Group(v1))
});
$c_Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$1.prototype.apply__Lscalaspace_Group__Lgoogle_maps_Marker = (function(group) {
  ...
  $g["google"]["maps"]["event"]["addListener"](marker, "click", (function(arg$outer, marker$1, group$1) {
    return (function() {
      $m_Lscalaspace_ScalaSpace$().onClick__Lgoogle_maps_Map__Lgoogle_maps_Marker__Lscalaspace_Group__V(arg$outer.$$outer$2.map$1$f, marker$1, group$1)
    })
  })(this, marker, group));
  return marker
});
var $d_Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$1 = new $TypeData().initClass({
  Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$1: 0
}, false, "scalaspace.ScalaSpace$$anonfun$initialize$1$$anonfun$1", {
  Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$1: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$1.prototype.$classData = $d_Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$1;
/** @constructor */
...
$c_Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$derive$macro$1$lzycompute$1$1.prototype.apply__Lupickle_Types$Reader = (function() {
  ...
  var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$32$2) {
    ...
    if ((x$32 !== null)) {
      var x = x$32.$$und1$f;
      return new $c_Lscalaspace_Groups().init___sjs_js_Array(x)
    } else {
...
$c_Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$derive$macro$1$lzycompute$1$1$$anonfun$derive$macro$5$lzycompute$1$1.prototype.apply__Lupickle_Types$Reader = (function() {
  var this$10 = $m_Lupickle_default$();
  var f = new $c_Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$derive$macro$1$lzycompute$1$1$$anonfun$derive$macro$5$lzycompute$1$1$$anonfun$apply$3().init___Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$derive$macro$1$lzycompute$1$1$$anonfun$derive$macro$5$lzycompute$1$1(this);
...
/** @constructor */
var $c_Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$derive$macro$1$lzycompute$1$1$$anonfun$derive$macro$5$lzycompute$1$1$$anonfun$apply$3 = (function() {
  $c_sr_AbstractFunction1.call(this)
});
$c_Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$derive$macro$1$lzycompute$1$1$$anonfun$derive$macro$5$lzycompute$1$1$$anonfun$apply$3.prototype = new $h_sr_AbstractFunction1();
$c_Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$derive$macro$1$lzycompute$1$1$$anonfun$derive$macro$5$lzycompute$1$1$$anonfun$apply$3.prototype.constructor = $c_Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$derive$macro$1$lzycompute$1$1$$anonfun$derive$macro$5$lzycompute$1$1$$anonfun$apply$3;
/** @constructor */
var $h_Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$derive$macro$1$lzycompute$1$1$$anonfun$derive$macro$5$lzycompute$1$1$$anonfun$apply$3 = (function() {
  /*<skip>*/
});
$h_Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$derive$macro$1$lzycompute$1$1$$anonfun$derive$macro$5$lzycompute$1$1$$anonfun$apply$3.prototype = $c_Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$derive$macro$1$lzycompute$1$1$$anonfun$derive$macro$5$lzycompute$1$1$$anonfun$apply$3.prototype;
$c_Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$derive$macro$1$lzycompute$1$1$$anonfun$derive$macro$5$lzycompute$1$1$$anonfun$apply$3.prototype.apply__O__O = (function(v1) {
  return this.apply__T5__Lscalaspace_Group($as_T5(v1))
});
$c_Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$derive$macro$1$lzycompute$1$1$$anonfun$derive$macro$5$lzycompute$1$1$$anonfun$apply$3.prototype.apply__T5__Lscalaspace_Group = (function(derive$macro$11) {
...
$c_Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$derive$macro$1$lzycompute$1$1$$anonfun$derive$macro$5$lzycompute$1$1$$anonfun$apply$3.prototype.init___Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$derive$macro$1$lzycompute$1$1$$anonfun$derive$macro$5$lzycompute$1$1 = (function($$outer) {
  return this
});
var $d_Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$derive$macro$1$lzycompute$1$1$$anonfun$derive$macro$5$lzycompute$1$1$$anonfun$apply$3 = new $TypeData().initClass({
  Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$derive$macro$1$lzycompute$1$1$$anonfun$derive$macro$5$lzycompute$1$1$$anonfun$apply$3: 0
}, false, "scalaspace.ScalaSpace$$anonfun$initialize$1$$anonfun$derive$macro$1$lzycompute$1$1$$anonfun$derive$macro$5$lzycompute$1$1$$anonfun$apply$3", {
  Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$derive$macro$1$lzycompute$1$1$$anonfun$derive$macro$5$lzycompute$1$1$$anonfun$apply$3: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$derive$macro$1$lzycompute$1$1$$anonfun$derive$macro$5$lzycompute$1$1$$anonfun$apply$3.prototype.$classData = $d_Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$derive$macro$1$lzycompute$1$1$$anonfun$derive$macro$5$lzycompute$1$1$$anonfun$apply$3;
/** @constructor */
...
$c_Lscalaspace_ScalaSpace$$anonfun$initialize$1.prototype = new $h_sr_AbstractPartialFunction();
...
$c_Lscalaspace_ScalaSpace$$anonfun$initialize$1.prototype.applyOrElse__Lorg_scalajs_dom_raw_XMLHttpRequest__F1__O = (function(x1, default$2) {
  if ((x1 !== null)) {
    var this$1 = $m_Lupickle_default$();
    var expr = $as_T(x1["responseText"]);
    var evidence$3 = this.derive$macro$4$1__p2__Lupickle_Types$Reader();
    var array = $as_Lscalaspace_Groups($s_Lupickle_Types$class__read__Lupickle_Types__T__Lupickle_Types$Reader__O(this$1, expr, evidence$3)).groups$1;
    var f = new $c_Lscalaspace_ScalaSpace$$anonfun$initialize$1$$anonfun$1().init___Lscalaspace_ScalaSpace$$anonfun$initialize$1(this);
    var array$1 = [];
    $uI(array["length"]);
    var i = 0;
    ...
    while ((i < len)) {
      ...
      var elem = f.apply__Lscalaspace_Group__Lgoogle_maps_Marker($as_Lscalaspace_Group(arg1));
      array$1["push"](elem);
      i = ((1 + i) | 0)
    };
    new $g["MarkerClusterer"](this.map$1$f, array$1, {
      "gridSize": 50,
      "minimumClusterSize": 2
    });
    return (($g["navigator"]["geolocation"] !== null) ? ($g["navigator"]["geolocation"]["getCurrentPosition"]((function(arg$outer) {
      return (function(position$2) {
        arg$outer.map$1$f["setCenter"](new $g["google"]["maps"]["LatLng"]($uD(position$2["coords"]["latitude"]), $uD(position$2["coords"]["longitude"])))
      })
    })(this)), (void 0)) : (void 0))
  } else {
...
$c_Lscalaspace_ScalaSpace$$anonfun$initialize$1.prototype.isDefinedAt__Lorg_scalajs_dom_raw_XMLHttpRequest__Z = (function(x1) {
  return (x1 !== null)
});
$c_Lscalaspace_ScalaSpace$$anonfun$initialize$1.prototype.init___Lgoogle_maps_Map = (function(map$1) {
  this.map$1$f = map$1;
  return this
});
$c_Lscalaspace_ScalaSpace$$anonfun$initialize$1.prototype.isDefinedAt__O__Z = (function(x) {
  return this.isDefinedAt__Lorg_scalajs_dom_raw_XMLHttpRequest__Z(x)
});
$c_Lscalaspace_ScalaSpace$$anonfun$initialize$1.prototype.applyOrElse__O__F1__O = (function(x, default$2) {
...
/** @constructor */
var $c_sjs_js_ArrayOps = (function() {
  $c_O.call(this);
...
/** @constructor */
var $h_sjs_js_ArrayOps = (function() {
  /*<skip>*/
});
